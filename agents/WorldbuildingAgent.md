...
- World Spine work loads this agent by default. Load `EditorAgent.md` only for editor-wide boundary changes, `PersistenceAgent.md` only for changed persistence semantics, and `DomainSchemaAgent.md` only for schema/contracts.
