...
- Revision-history banking plumbing with session aggregation, diff previews, a revision-panel controller/view, and a storage adapter behind the benched scene-editor revision overlay.
