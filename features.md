...
1.11 Anchor-aware decoration drift pipeline
   ...
   1.11g User highlights write canonical manuscript marks, render through author-mark projections, appear in the Decorations console, and support pending highlight typing from a collapsed caret.
...
- Process update (2026-06-04): implemented the first working Decorations feature slice with user highlights. The editor Highlight control now writes canonical `ManuscriptMark` records through the direct mark planner, removes highlight ranges from the scene compatibility field, persists marks through the project record path, and repaints the author-mark overlay after layout refresh. A new Decorations tab in the right console lists user highlights from `workspace.project.marks`, groups them by chapter, jumps back to the highlighted manuscript range, and deletes highlight marks without persisting runtime projection objects.
...
- Process update (2026-06-06): extended the Decorations panel with a panel-side Highlight selection command for drag-selected manuscript passages. The panel model now receives the active manuscript selection preview from the shell, the command routes through the same canonical user-highlight mutation path, and scene-editor drag selections refresh on pointerup before the panel command runs.
...
- Status: `Implemented`
- Code locations: `apps/editor/public/features/manuscript-editor/manuscript-selection-controller.js:3-215` (selection, context range, bookmark, and persisted defaults policy), `apps/editor/public/adapters/editor-host/textarea-editor-host.js:127-326` (host focus, selection range, bookmark, viewport, offset-centering, and wrap metrics), `apps/editor/public/adapters/editor-host/textarea-editor-host.js:703-740` (pure visual-line offset helpers), `apps/editor/public/app.js:3884-3996`, `apps/editor/public/app.js:7430-7609`, `apps/editor/public/app.js:9192-9419`, `apps/editor/public/app.js:9460-9468`, and `apps/editor/public/app.js:9886-9913` (shell orchestration calls through host capabilities), `test/manuscript-selection-controller.test.mjs:6-91` and `test/manuscript-editor-host.test.mjs:18-123` (policy and host behavior)
...
- Flow-on effects: autosave and reload can preserve author context, issue/task/note navigation lands in useful manuscript positions, pane-local scrolling avoids browser-page jumps, visual-line math is testable outside `app.js`, and a later editor adapter can provide equivalent navigation capabilities without rewriting feature controllers
...
- Code locations: `apps/editor/public/features/manuscript-editor/manuscript-command-controller.js:3-518` (format command, pending-format switch state, caret-anchored inserted-text resolution, and compatibility range mutation policy), `apps/editor/public/features/manuscript-editor/manuscript-input-controller.js:7-89` (live typing sequence with post-input caret offsets), `apps/editor/public/features/manuscript-editor/manuscript-block-text-service.js:1-221` (draft block text synchronization and fresh-scene block fallback from flat textarea edits), `apps/editor/public/features/manuscript-editor/manuscript-mark-service.js:1-821` (legacy range to schema-shaped mark conversion, compatibility mark sync, direct mark mutation planning, block-local anchor splitting, tolerant saved-project text mapping, bounded evidence, and projection bridge), `apps/editor/public/features/manuscript-editor/projection-selector.js:1-359` (author-mark projection source now prefers explicit/derived marks before legacy ranges and suppresses duplicate compatibility derivation), `apps/editor/public/features/manuscript-decorations/user-highlight-command-service.js:1-172` (selected-range versus pending-caret command intent and live/cached selection recovery for toolbar-triggered highlights), `apps/editor/public/features/manuscript-decorations/user-highlight-panel.js:1-195` (Decorations panel model/markup and panel-side Highlight selection command for user highlights), `apps/editor/public/features/manuscript-editor/editor-host-interface.js:7-47` (render-only host contract), `apps/editor/public/adapters/editor-host/textarea-editor-host.js:50-94`, `apps/editor/public/adapters/editor-host/textarea-editor-host.js:333-349`, and `apps/editor/public/adapters/editor-host/textarea-editor-host.js:517-545` (textarea markup, author-mark repaint, and painting), `apps/editor/public/features/scene-editor.js:172-179` and `apps/editor/public/features/scene-editor.js:266-273` (scene host projection input), `apps/editor/public/app.js:112-113`, `apps/editor/public/app.js:507-522`, `apps/editor/public/app.js:2921-2955`, `apps/editor/public/app.js:4081-4106`, `apps/editor/public/app.js:5262-5286`, `apps/editor/public/app.js:6478-6533`, `apps/editor/public/app.js:9603-9605`, and `apps/editor/public/app.js:9978-10164` (mark imports, input commit block sync, paste-input dispatch, highlight active-state, author-mark repaint, live mark anchor drift, inline command dispatch/pending switch path, live draft-scene reconciliation, generic author-mark command, pending-off helper, and mark metadata), `apps/editor/public/styles.css:2907-2941` and `apps/editor/public/styles.css:4022-4071` (visible highlight overlay and list styling), `apps/editor/public/editor-model.js:255-361`, `apps/editor/public/adapters/storage/project-repository.js:57-70`, `apps/editor/public/adapters/storage/project-repository.js:181-190`, and `apps/editor/public/adapters/storage/project-migrations.js:120-131` (paragraph identity preservation and marks collection migration), `packages/manuscript-schema/src/index.ts:21-55`, `packages/manuscript-schema/src/index.ts:178-211`, `packages/manuscript-schema/src/index.ts:745-783`, and `packages/manuscript-schema/src/index.ts:890-918` (canonical mark DTO, sequence, bounded evidence/status, mutation target, and bounded evidence helper), `test/manuscript-command-controller.test.mjs:1-176`, `test/manuscript-input-controller.test.mjs:1-150`, `test/manuscript-anchor-services.test.mjs:441-469`, `test/manuscript-mark-service.test.mjs:1-370`, `test/manuscript-projection-selector.test.mjs:10-373`, `test/user-highlight-command-service.test.mjs:1-142`, `test/user-highlight-panel.test.mjs:1-93`, `test/desktop-application.test.mjs:758-762`, `test/project-service-storage.test.mjs:76`, `test/manuscript-editor-host.test.mjs:18-91`, `test/project-refresh-persistence.test.mjs`, `test/editor-model.test.mjs:38-123`, and `test/manuscript-schema.test.mjs:139-211` (command, input, block-sync, fresh-scene block fallback, mark conversion/sync/mutation planning, visual-channel, user-highlight command recovery/pending intent, user-highlight panel, visible overlay guard, saved-project fixture mapping, repeated-character and selected-mark drift guards, fresh-scene Bold/Highlight projection, migration, host, persistence, paragraph identity, and schema mutation evidence)
...
- Execution flow: author drag-selects manuscript text and presses toolbar Bold or Highlight, or presses the Decorations-panel Highlight selection command -> shell captures the current scene-editor selection before browser focus changes and refreshes drag selections on pointerup -> the mark command reconciles visible textarea text into scene draft text/blocks when a fresh draft scene is ahead of state -> the mark command prefers the live textarea selection and falls back to the cached same-scene selection if the click collapsed the live range -> selected Bold/Highlight routes to the canonical mark planner, while collapsed Bold/Highlight toggles the pending switch for incoming text -> retained same-kind compatibility marks are promoted to durable IDs before legacy ranges for that mark kind are removed -> `workspace.project.marks` receives added/removed/split/promoted `ManuscriptMark` records and updated mark sequence state -> project persistence records the mark mutation through the existing scene/project save path -> projection selector emits author-mark projections from canonical marks -> textarea host repaints the author-mark layer -> Decorations tab lists user highlights and can navigate/delete them
...
- Code locations: `Design notes/anchor-decoration-drift-handling-design.md` (source design), `docs/architecture/editor-application-roadmap.md` (Phase 7 roadmap), `docs/architecture/manuscript-decoration-layer.md` (anchor drift contract and implementation sequence), `packages/manuscript-schema/src/index.ts:21-55`, `packages/manuscript-schema/src/index.ts:178-211`, `packages/manuscript-schema/src/index.ts:745-783`, and `packages/manuscript-schema/src/index.ts:890-918` (canonical `ManuscriptMark` DTO, sequence, evidence/status fields, bounded evidence helper, and mutation), `apps/editor/public/features/manuscript-editor/manuscript-mark-service.js:1-821` (legacy range to canonical mark projection/sync adapter, tolerant saved-project text mapping, and direct canonical mark mutation planner), `apps/editor/public/features/manuscript-decorations/user-highlight-command-service.js:1-172` (selected-range versus pending-caret command intent and live/cached selection recovery for toolbar-triggered highlights), `apps/editor/public/features/manuscript-decorations/user-highlight-panel.js:1-195` (Decorations panel model/markup and panel-side Highlight selection command for user highlights), `apps/editor/public/adapters/storage/project-migrations.js:120-131` (marks collection migration), `apps/editor/public/features/manuscript-anchors/manuscript-anchor-service.js:2-206` (anchor status/evidence/DTO normalization), `apps/editor/public/features/manuscript-anchors/manuscript-edit-transaction-service.js:4-62` (runtime-only edit transaction derivation), `apps/editor/public/features/manuscript-anchors/manuscript-anchor-mutation-service.js:7-169` (live offset/status mutation), `apps/editor/public/features/manuscript-anchors/manuscript-anchor-validation-service.js:9-134` (hash validation and context recovery), `apps/editor/public/features/manuscript-anchors/manuscript-anchor-index-service.js:8-30` and `apps/editor/public/features/manuscript-anchors/manuscript-anchor-index-service.js:102-139` (active-scene anchor index for issue/task/note/mark/event/revision/narration owners), `apps/editor/public/features/manuscript-anchors/manuscript-decoration-projection-service.js:7-144` (anchor-backed and runtime-only projection DTOs), `apps/editor/public/features/manuscript-anchors/manuscript-anchor-record-service.js:20-303` and `apps/editor/public/features/manuscript-anchors/manuscript-anchor-record-service.js:476-973` (offset and canonical anchor live drift, evidence patches, validation, and repair APIs), `apps/editor/public/features/manuscript-anchors/manuscript-anchor-idle-validation-scheduler.js:5-82` (debounced idle validation), `apps/editor/public/features/anchored-records/anchored-record-controller.js:51-101` (initial bounded evidence on new task/note records), `apps/editor/public/features/anchored-records/anchored-record-service.js:64-104` and `apps/editor/public/features/anchored-records/anchored-record-service.js:158-198` (metadata patch persistence for task/note repair), `apps/editor/public/features/manuscript-editor/anchored-record-navigation-controller.js:31-64` and `apps/editor/public/features/manuscript-editor/anchored-record-navigation-controller.js:116-124` (lazy range resolution and stale-range suppression), `apps/editor/public/features/manuscript-editor/manuscript-input-controller.js:16-89` (anchor update hook and caret-aware pending highlight input sequence), `apps/editor/public/features/manuscript-editor/projection-selector.js:1-359`, `apps/editor/public/features/scene-editor.js:172-179`, `apps/editor/public/app.js:112-113`, `apps/editor/public/app.js:497-501`, `apps/editor/public/app.js:1208-1257`, `apps/editor/public/app.js:1470-1473`, `apps/editor/public/app.js:1733-1739`, `apps/editor/public/app.js:3370`, `apps/editor/public/app.js:4081-4106`, `apps/editor/public/app.js:4295-4344`, `apps/editor/public/app.js:5262-5286`, `apps/editor/public/app.js:6263-6519`, `apps/editor/public/app.js:6529-6699`, `apps/editor/public/app.js:9536-9585`, and `apps/editor/public/app.js:9861-9956` (idle scheduler, user-highlight command import/actions, selection-consuming command capture, Decorations tab, active-state, panel render/active selection preview, author-mark repaint, live task/note/issue/event/narration drift, block-local canonical edit mapping, load/idle validation, narration validation, inline pending switch path, highlight command dispatch/selection recovery, and select/delete behavior), `test/manuscript-anchor-services.test.mjs:29-520`, `test/manuscript-mark-service.test.mjs:1-522`, `test/manuscript-projection-selector.test.mjs:10-373`, `test/user-highlight-command-service.test.mjs:1-142`, `test/user-highlight-panel.test.mjs:1-93`, `test/desktop-application.test.mjs:758-762`, `test/project-service-storage.test.mjs:76`, `test/manuscript-schema.test.mjs:139-211`, `test/anchored-record-controller.test.mjs:83-96`, `test/anchored-record-navigation-controller.test.mjs:8-76`, `test/anchored-record-service.test.mjs:63-139`, `test/manuscript-input-controller.test.mjs:6-93`
...
- Extraction/port notes: this refactor phase now has a working Decorations panel slice for user highlights and direct canonical mark writes for Bold. Next decoration work should add channel visibility controls and migrate italic, underline, strikethrough, or additional durable decoration types onto canonical mark/record DTOs.
...
- Feature 1.10 - Manuscript inline formatting commands: `apps/editor/public/features/manuscript-editor/manuscript-command-controller.js:3-518`, `apps/editor/public/features/manuscript-editor/manuscript-input-controller.js:7-89`, `apps/editor/public/features/manuscript-editor/manuscript-mark-service.js:1-821`, `apps/editor/public/features/manuscript-editor/projection-selector.js:1-359`, `apps/editor/public/features/manuscript-decorations/user-highlight-command-service.js:1-172`, `apps/editor/public/features/manuscript-decorations/user-highlight-panel.js:1-195`, `apps/editor/public/features/manuscript-editor/editor-host-interface.js:7-47`, `apps/editor/public/adapters/editor-host/textarea-editor-host.js:50-94`, `apps/editor/public/adapters/editor-host/textarea-editor-host.js:333-349`, `apps/editor/public/adapters/editor-host/textarea-editor-host.js:517-545`, `apps/editor/public/features/scene-editor.js:172-273`, `apps/editor/public/app.js:112-113`, `apps/editor/public/app.js:1208-1257`, `apps/editor/public/app.js:1470-1473`, `apps/editor/public/app.js:1733-1739`, `apps/editor/public/app.js:3370`, `apps/editor/public/app.js:4081-4106`, `apps/editor/public/app.js:4197`, `apps/editor/public/app.js:4295-4344`, `apps/editor/public/app.js:5262-5286`, `apps/editor/public/app.js:9536-9585`, `apps/editor/public/app.js:9861-9956`, `apps/editor/public/styles.css:2907-2941`, `apps/editor/public/styles.css:4022-4071`, `apps/editor/public/editor-model.js:255-361`, `apps/editor/public/adapters/storage/project-repository.js:57-70`, `apps/editor/public/adapters/storage/project-repository.js:181-190`, `apps/editor/public/adapters/storage/project-migrations.js:120-131`, `packages/manuscript-schema/src/index.ts:21-55`, `packages/manuscript-schema/src/index.ts:178-211`, `packages/manuscript-schema/src/index.ts:745-783`, `packages/manuscript-schema/src/index.ts:890-918`, `test/manuscript-command-controller.test.mjs:1-176`, `test/manuscript-input-controller.test.mjs:1-93`, `test/manuscript-mark-service.test.mjs:1-522`, `test/manuscript-projection-selector.test.mjs:10-373`, `test/user-highlight-command-service.test.mjs:1-142`, `test/user-highlight-panel.test.mjs:1-93`, `test/desktop-application.test.mjs:758-762`, `test/project-service-storage.test.mjs:76`, `test/manuscript-schema.test.mjs:139-211`.
- Feature 1.11 - Anchor-aware decoration drift pipeline: `Design notes/anchor-decoration-drift-handling-design.md`, `docs/architecture/editor-application-roadmap.md`, `docs/architecture/manuscript-decoration-layer.md`, `packages/manuscript-schema/src/index.ts:21-55`, `packages/manuscript-schema/src/index.ts:178-211`, `packages/manuscript-schema/src/index.ts:745-783`, `packages/manuscript-schema/src/index.ts:890-918`, `apps/editor/public/features/manuscript-editor/manuscript-mark-service.js:1-821`, `apps/editor/public/features/manuscript-decorations/user-highlight-command-service.js:1-172`, `apps/editor/public/features/manuscript-decorations/user-highlight-panel.js:1-195`, `apps/editor/public/adapters/storage/project-migrations.js:120-131`, `apps/editor/public/features/manuscript-anchors/manuscript-anchor-service.js:2-206`, `apps/editor/public/features/manuscript-anchors/manuscript-edit-transaction-service.js:4-62`, `apps/editor/public/features/manuscript-anchors/manuscript-anchor-mutation-service.js:7-169`, `apps/editor/public/features/manuscript-anchors/manuscript-anchor-validation-service.js:9-134`, `apps/editor/public/features/manuscript-anchors/manuscript-anchor-index-service.js:8-30`, `apps/editor/public/features/manuscript-anchors/manuscript-anchor-index-service.js:102-139`, `apps/editor/public/features/manuscript-anchors/manuscript-decoration-projection-service.js:7-144`, `apps/editor/public/features/manuscript-anchors/manuscript-anchor-record-service.js:20-303`, `apps/editor/public/features/manuscript-anchors/manuscript-anchor-record-service.js:476-973`, `apps/editor/public/features/manuscript-anchors/manuscript-anchor-idle-validation-scheduler.js:5-82`, `apps/editor/public/features/anchored-records/anchored-record-controller.js:51-101`, `apps/editor/public/features/anchored-records/anchored-record-service.js:64-198`, `apps/editor/public/features/manuscript-editor/anchored-record-navigation-controller.js:31-124`, `apps/editor/public/features/manuscript-editor/projection-selector.js:1-359`, `apps/editor/public/features/scene-editor.js:172-179`, `apps/editor/public/app.js:112-113`, `apps/editor/public/app.js:497-501`, `apps/editor/public/app.js:1208-1257`, `apps/editor/public/app.js:1470-1473`, `apps/editor/public/app.js:1733-1739`, `apps/editor/public/app.js:3370`, `apps/editor/public/app.js:4081-4106`, `apps/editor/public/app.js:4295-4344`, `apps/editor/public/app.js:5262-5286`, `apps/editor/public/app.js:6263-6519`, `apps/editor/public/app.js:6529-6699`, `apps/editor/public/app.js:9536-9585`, `apps/editor/public/app.js:9861-9956`, `test/manuscript-anchor-services.test.mjs:29-520`, `test/manuscript-mark-service.test.mjs:1-522`, `test/manuscript-projection-selector.test.mjs:10-373`, `test/user-highlight-command-service.test.mjs:1-142`, `test/user-highlight-panel.test.mjs:1-93`, `test/desktop-application.test.mjs:758-762`, `test/project-service-storage.test.mjs:76`, `test/manuscript-schema.test.mjs:139-211`, `test/anchored-record-controller.test.mjs:83-96`, `test/anchored-record-navigation-controller.test.mjs:8-76`, `test/anchored-record-service.test.mjs:63-139`.
