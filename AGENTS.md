...
- Treat comments as durable context for human maintainers and future agents. Add concise comments for non-obvious intent, invariants, failure prevention, and meaningful stages inside functions/tests—especially persistence/filesystem authority, ordering/concurrency, compatibility, isolation, and deterministic harness logic. Explain why or what failure is prevented; do not narrate syntax.
