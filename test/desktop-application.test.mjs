...
export async function runDesktopApplicationTest() {
  ...
  assert.match(appScript.body, /recordDraftProofCoverageFromViewport/);
  ...
  assert.match(taskContextMenuScript.body, /Inspiration/);
  assert.match(taskContextMenuScript.body, /Research/);
  ...
  assert.match(appScript.body, /MANUSCRIPT_INLINE_FORMAT_SHORTCUTS/);
  assert.match(appScript.body, /b: "bold"/);
  assert.match(appScript.body, /h: "highlight"/);
  assert.match(appScript.body, /i: "italic"/);
