// Intent: annotate existing Serva Vitae anchored tasks as one lore-revision chain for manual task-iteration testing.
(() => {
  ...
  const iterations = [
    {
      taskId: "source-comment-25f39d38-61ca-4214-b185-11f84d4f7e6e-3dd04504-9254-4b17-bbe1-0045a76b1558",
      label: "1a",
      index: 0,
    ...
    {
      taskId: "source-comment-622d5022-8f5d-4f30-ac3f-ca62ac5831df-bec43002-6c7c-4b9c-8d8d-9afff0ca7b41",
      label: "1b",
      index: 1,
    ...
    {
      taskId: "source-comment-915d6d88-2f76-4e99-adb0-cfa7e9f0659c-4a92e16e-f7d8-4440-9cf0-710dd12b030c",
      label: "1c",
      index: 2,
    ...
    {
      taskId: "source-comment-1c495c92-3273-4f77-8eff-5b748ba386c8-5040544f-1e7a-4811-96d4-745809fead9b",
      label: "1d",
      index: 3,
  ...
  for (const iteration of iterations) {
    const task = tasks.find((candidate) => candidate?.id === iteration.taskId);
    if (!task) {
      continue;
    }
